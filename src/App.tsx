  ...
  return (
    <div className="min-h-screen bg-dark-bg selection:bg-gold selection:text-black">
      ...
      >
        ...
        <span className="absolute right-full mr-4 px-4 py-2 bg-white text-black text-sm font-bold rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none shadow-xl">
          Chat with us on WhatsApp
        </span>
      </a>

      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 glass-card border-b border-gold/10 px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-4">
          <img 
            src="https://i.ibb.co/CKgjw4rx/file-000000003bec71faa9b37e16b055cb49.png" 
            alt="Mithila Logo" 
            className="h-12 w-12 object-contain rounded-full border border-gold/30 cursor-pointer hover:scale-110 transition-transform"
          ...
          <div className="hidden md:flex gap-8 text-sm uppercase tracking-widest font-medium text-white/70">
            ...
            <a href="#ai-planner" className="hover:text-gold transition-colors">AI Planner</a>
            <a href="#enquiry" className="hover:text-gold transition-colors">Enquiry</a>
          </div>
        </div>
        
        <div className="text-right">
          <div className="text-lg md:text-xl font-serif font-bold gold-gradient leading-tight">Mithila Catering &</div>
          <div className="text-lg md:text-xl font-serif font-bold gold-gradient leading-tight">Decoration Service</div>
        </div>
      </nav>
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 pb-20">
        ...
        <div className="relative z-10 px-6 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <span className="text-gold uppercase tracking-[0.3em] text-sm font-semibold mb-4 block">Established Since 2021</span>
              <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6 leading-tight">
                Mithila Catering & <br />
                <span className="gold-gradient italic">Decoration Service</span>
              </h1>
              <h2 className="text-2xl md:text-3xl font-serif text-gold-light mb-6">
                Crafting Unforgettable Moments Across India
              </h2>
              <p className="text-white/70 text-lg md:text-xl mb-10 font-light leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#ai-planner" className="px-8 py-4 gold-bg text-black font-bold rounded-full text-lg hover:shadow-[0_0_20px_rgba(212,175,55,0.4)] transition-all flex items-center justify-center gap-2">
                  <Sparkles className="w-5 h-5" />
                  Start AI Planning
                </a>
                <a href="#enquiry" className="px-8 py-4 border border-gold/30 text-gold font-bold rounded-full text-lg hover:bg-gold/10 transition-all flex items-center justify-center gap-2">
            ...
            >
              <div className="absolute -inset-4 gold-bg opacity-20 blur-3xl rounded-full" />
              <img 
                src="https://i.ibb.co/XZZwcN2h/Whats-App-Image-2026-03-15-at-15-56-19-1.jpg" 
                alt="Mithila Catering Showcase" 
                className="relative w-full h-auto rounded-[2rem] shadow-2xl border border-gold/20 object-cover"
                referrerPolicy="no-referrer"
              />
              <div className="absolute -bottom-6 -right-6 glass-card p-6 rounded-2xl border-gold/30 hidden md:block">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 gold-bg rounded-lg flex items-center justify-center text-black">
                    <Star className="w-6 h-6" />
                  </div>
                  <div>
                    <p className="text-gold font-bold text-xl">Premium</p>
      ...
      <section id="services" className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-white/50 max-w-2xl mx-auto">Authentic Mithila flavors combined with world-class decoration and management.</p>
        </div>
      ...
      <footer className="py-12 px-6 border-t border-gold/10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="text-3xl font-serif font-bold gold-gradient">Mithila</div>
