            ...
            <>
              ...
              >
                ...
                <div className="flex flex-col gap-6 text-xl font-serif font-bold text-gray-900">
                  <a href="#home" onClick={() => { setCurrentView('main'); setIsMobileMenuOpen(false); }} className="hover:text-gold transition-colors flex items-center gap-3 py-2 border-b border-gray-100">
                    Home
                  </a>
                  <a href="#services" onClick={() => { setCurrentView('main'); setIsMobileMenuOpen(false); }} className="hover:text-gold transition-colors flex items-center gap-3 py-2 border-b border-gray-100">
                    Services
                  </a>
                  <a href="#ai-planner" onClick={() => { setCurrentView('main'); setIsMobileMenuOpen(false); }} className="hover:text-gold transition-colors flex items-center gap-3 py-2 border-b border-gray-100">
                    AI Planner
                  </a>
                  <button 
                  ...
                  <a href="#enquiry" onClick={() => { setCurrentView('main'); setIsMobileMenuOpen(false); }} className="hover:text-gold transition-colors flex items-center gap-3 py-2 border-b border-gray-100">
                    Enquiry
                  </a>
                  <a href="#gallery" onClick={() => { setCurrentView('main'); setIsMobileMenuOpen(false); }} className="hover:text-gold transition-colors flex items-center gap-3 py-2 border-b border-gray-100">
                    Event Gallery
                  </a>
                </div>
