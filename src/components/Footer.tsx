      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-600">
            <li><a href="/index.html" className="hover:text-gold transition-colors">Home</a></li>
            <li><a href="/services.html" className="hover:text-gold transition-colors">Services</a></li>
            <li><a href="/gallery.html" className="hover:text-gold transition-colors">Gallery</a></li>
            <li><a href="/enquiry.html" className="hover:text-gold transition-colors">Enquiry</a></li>
            <li><a href="/contact.html" className="hover:text-gold transition-colors">Contact</a></li>
            <li><a href="/tiffin.html" className="hover:text-gold transition-colors">Tiffin Service</a></li>
          </ul>
        </div>
